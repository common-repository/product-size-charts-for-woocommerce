    ...
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH Product Size Charts for WooCommerce%2$s to benefit from all features!','yith-wcpsc'),'<span class="highlight">','</span>' );?>
                </p>
                <a href="<?php echo $this->get_premium_landing_uri() ?>" target="_blank" class="premium-cta-button button btn">
                    <span class="highlight"><?php _e('UPGRADE','yith-wcpsc');?></span>
                    <span><?php _e('to the premium version','yith-wcpsc');?></span>
                </a>
            </div>
        </div>
    </div>
    <div class="one section section-even clear">
        <h1><?php _e('Premium Features','yith-wcpsc');?></h1>
        <div class="landing-container">
            <div class="col-1">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('More than one size chart','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php _e('Assign as many size charts as you wish to the same product: choose them directly from within the product, so that you can show your users several charts showing information in a tidy and customised way.', 'yith-wcpsc');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e( 'Entirely customisable popup buttons','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('You can choose the position, in product page, for the %1$sbutton%2$s that will open the %1$schart popup%2$s.%3$sAnd what\'s more, you can also customise its colors and style as you prefer.', 'yith-wcpsc'), '<b>', '</b>','<br>');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Popup settings ','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('Change the %1$sstyle of your size charts%2$s. Set colour, opening effects and graphic layout of your popup: besides the default one available, you can choose among %1$s3 premium templates%2$s for your popup and you can also edit overlay colour and opacity.', 'yith-wcpsc'), '<b>', '</b>');?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Chart style','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Give %1$syour own style to the charts%2$s.%3$sChange their colour and graphic style: choose among %1$s3 different premium templates%2$s, besides default one, which can be either used in combination with popup styles or regardless of them.','yith-wcpsc'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Bulk Editing','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Assigning one or more size charts to more products at the same time is easy: select your products and, then, assign them the table you want using %1$sWordPress bulk editing tool%2$s.','yith-wcpsc'),'<b>','</b>'); ?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Widget','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'A way to make all your tables created in your shop stand out.%3$sWith the widget %1$s"YITH Product Size Charts"%2$s, you\'ll be able to add a list with the tables created into the sidebars of your e-commerce, so that they can be highlighted for your users.','yith-wcpsc' ),'<b>','</b>','<br>' ) ?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Shortcodes, PHP code, tinyMCE','yith-wcpsc');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Add your size charts easily into your e-commerce with the %1$sshortcodes%2$s available, using %1$sPHP code%2$s or using %1$stinyMCE editor%2$s.','yith-wcpsc'),'<b>','</b>'); ?>
                </p>
            </div>
        </div>
    </div>
